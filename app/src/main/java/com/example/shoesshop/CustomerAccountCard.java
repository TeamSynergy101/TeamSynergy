...
import com.example.shoesshop.Models.CardDetails;
    ...
    class MyAdapter extends ArrayAdapter<CardDetails> {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            holder.button3.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    final AlertDialog alertDialog = new AlertDialog.Builder(getContext())
                            .setTitle("Payment Completed!. Add your Feedback")
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {

                                    Intent intent = new Intent(CustomerAccountCard.this, AddFeedback.class);
