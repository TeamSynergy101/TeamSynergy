...
import com.example.shoesshop.Models.OrderedItems;
...
public class OrderedShoeList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ordered_shoe_list);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                MyAdapter adapter = new MyAdapter(OrderedShoeList.this, R.layout.custom_shoe_ordered_details, (ArrayList<OrderedItems>) user);
    ...
    class MyAdapter extends ArrayAdapter<OrderedItems> {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            if (view == null) {
                ...
                view = inflater.inflate(R.layout.custom_shoe_ordered_details, null);
                    ...
                    final AlertDialog alertDialog = new AlertDialog.Builder(getContext())
                            ...
                            .setPositiveButton("Pay Online", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    Intent intent = new Intent(OrderedShoeList.this, CustomerAccountCard.class);
                    ...
                    buttonupdate.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (name.equals("")) {
                                ...
                                Toast.makeText(OrderedShoeList.this, "Updated successfully", Toast.LENGTH_SHORT).show();
