...
import com.example.shoesshop.Models.ProductDetails;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                DatabaseReference query = mDatabase.child("ProductDetails");
                query.orderByChild("name").startAt(editText.getText().toString());
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                MyAdapter adapter = new MyAdapter(ManageProducts.this, R.layout.custom_product_details, (ArrayList<ProductDetails>) user);
                    ...
                    buttonupdate.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (code.isEmpty()) {
                                ...
                                Toast.makeText(ManageProducts.this, "Updated successfully", Toast.LENGTH_SHORT).show();
